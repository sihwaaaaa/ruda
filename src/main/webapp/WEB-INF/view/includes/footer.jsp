...
<div
        ...
        aria-hidden="true"
>
    <form id="alarm-form" action="/diary/${token}/alarm" method="post">
        <div
                class="modal-dialog"
        ...
        >
            <div class="modal-content">
                ...
                <div class="modal-body ml-4 my-2 d-flex justify-content-center">
                    <input type="time" id="time-input" name="alarmTime" class="form-control"
                           style="width: 300px; height: 60px; cursor: pointer; font-size: 20px;">
                </div>
